...
|11주차|프로젝트 진행 – 병동에서 사용되는 환자 클래스 제작|O|
|12주차|프로젝트 진행 – 병동에서 사용되는 3D 인터페이스 제작|O|
|13주차|콘텐츠 중간점검 – 시연 및 피드백|O|
|14주차|콘텐츠 평가 - 피드백 내용 반영 후 최종평가|O|
|15주차|실무교육 - 사내 프로젝트 코드 분석|O|
|16주차|실무교육 - 사내 프로젝트를 기반으로 새로운 컨텐츠 제작|O|
|17주차|실무교육 - 사내 프로젝트를 기반으로 새로운 컨텐츠 제작|O|
|18주차|실무교육 - 제작한 컨텐츠 피드백 및 최종 평가|O|
